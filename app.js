...
function openCardDialog(card = null) {
  ...
  if (card) { $('#word-input').value = card.word; $('#translation-input').value = card.translation; $('#definition-input').value = card.definition || ''; $('#example-input').value = card.example || ''; }
